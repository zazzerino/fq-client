...
export enum ActionType {
  ...
  SET_ROUND_LENGTH = 'SET_ROUND_LENGTH',
}
...
export function newNoteToGuess(opts: NoteOpts, previousNote: string): NewNoteToGuessAction {
  let note: string;
  do {
...
export interface SetRoundLengthAction {
